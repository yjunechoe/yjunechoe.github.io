...
favorites <- c(
  ...
  "Futura Bk BT" = "A slender and bold member of the Futura family. Looks nice even in larger sizes. Has my favorite design of numbers.",
  "Lora" = "I generally try to stay away from serif fonts but if I had to choose one it'd be Lora"
)
