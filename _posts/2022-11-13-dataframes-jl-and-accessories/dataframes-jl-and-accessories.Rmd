...
**Disclaimer**: These are not a list of like/dislike or approve/disapprove. The 💜s and 💔s are just _vibes_ - you know what I mean?
...
For this particular problem you can use `pmax` and `pmin`, but that's of course not generalizable to other arbitrary operations:
