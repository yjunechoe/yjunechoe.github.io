...
- The very basics of working with spatial data with `{rnaturalearth}` and `{sf}`

- A bit about olor schemes for maps (particularly love this color <span style="background-color:#FFF8DC; padding-left:30px; border:1px solid black"></span>) as a way of de-emphasizing other territories in the map)
