...
Remember how I said R tends to play nicer with _.ttf_ than _.otf_ fonts?^[Again, YMMV but I've had to help a few people with this problem.] Lets go ahead and convert the _.otf_ files using an online converter, like [https://convertio.co/otf-ttf](https://convertio.co/otf-ttf). Now, with the three font files in _.ttf_ format, follow the instructions for installing fonts on your OS. 
...
- If you're design oriented, you can also **make your own icon font** for use in R. In Inkscape, you can do this in File > New From Template > Typography Canvas ([Guide](https://inkscape-manuals.readthedocs.io/en/latest/creating-custom-fonts.html)). Once you save your SVG font, you can convert it to _.ttf_ and follow the same installation process, and then it should be available in R if you render with `{ragg}`.
