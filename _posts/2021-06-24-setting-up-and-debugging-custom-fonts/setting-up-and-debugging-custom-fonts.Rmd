...
**tl;dr:** [don't use {showtext}](https://twitter.com/thomasp85/status/1355083725156077571) and [don't use {extrafont}](https://twitter.com/thomasp85/status/1261539815960518656) when following the workflow described in this blog post!^[And I can also personally attest that I used to use them until {ragg} was developed, and I never loaded these packages since. But this isn't a value judgment - if these packages continue to work for you, then great! But do know that there are some [known issues with reliability](https://twitter.com/CedScherer/status/1238532616564998148) (though to be fair, {extrafont} and {showtext} were one of the first attempts at solving the font rendering issue in R and they've actually done a great job over the years!).]
