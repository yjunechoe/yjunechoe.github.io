...
Here's another example just for fun - an "addition matrix":
...
mtcars %>% 
  ...
  reduce(
    as.character(.$mpg),
    ~ mutate(.x, !!.y := as.double(.y) + mpg),
    .init = .
  )
```

Let's now look at a less crazy, more practical application of this: **explicit dummy coding**!
